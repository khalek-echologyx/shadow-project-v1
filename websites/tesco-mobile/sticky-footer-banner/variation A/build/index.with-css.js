(function () {
  var interval = setInterval(function () {
    if (document.head) {
      ...
      style.innerHTML = `.sticky-footer-banner {
  position: fixed;
  bottom: 0;
  left: 0;
  width: calc(100% - 25px);
...
.sticky-footer-banner .sticky-footer-banner__content {
  position: relative;
  display: flex;
  align-items: center;
...
.sticky-footer-banner .sticky-footer-banner__content h4 {
  font-size: 16px;
  text-align: center;
  color: #333333;
}

.sticky-footer-banner .sticky-footer-banner__content h4 .title {
  margin-bottom: 0;
  display: inline;
}

.sticky-footer-banner .sticky-footer-banner__content h4 a {
  text-decoration: underline;
  margin: 0 3px;
}

.sticky-footer-banner .sticky-footer-banner__content h4 .subtitle {
  margin-bottom: 0;
...
.sticky-footer-banner
  .sticky-footer-banner__content
  .sticky-footer-banner__content__close {
  position: absolute;
  right: 0;
  top: 50%;
    ...
    poll(
      ...
      function () {
        var closeBtn = document.querySelector(
          ".sticky-footer-banner__content__close > svg",
        );
        var stickyFooterBannerElem = document.querySelector(
          ".sticky-footer-banner",
        );
    ...
    poll(
      ...
      function () {
        var loginLink = document.querySelector(
          ".sticky-footer-banner__content__text a",
        );
