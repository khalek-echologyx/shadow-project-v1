...
.car-summary-section .accordion-section {
  margin: 16px 0;
}
...
.car-summary-section .price-info .total-label .total-price {
  font-size: 16px;
  line-height: 24px;
  color: #000;
  font-weight: 500;
...
#avis-addOns-variation-C .protection-cards-column {
  position: relative;
}
...
(function () {
  ...
  function checkState() {
    ...
    $('span[data-testid="single-protections-item-included-in-bundle"]').filter(
      function () {
