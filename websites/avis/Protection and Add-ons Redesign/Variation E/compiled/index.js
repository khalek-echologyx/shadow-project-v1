(function () {
  ...
  function injectProtectionLayout() {
    ...
    poll(
      function () {
        return document.querySelector('[data-testid="ancillaries-action-footer"]');
      },
      function () {
        var actionFooter = document.querySelector('[data-testid="ancillaries-action-footer"]');
        actionFooter.style.position = "sticky";
        actionFooter.style.bottom = "0px";
        actionFooter.style.zIndex = "2";
      }
    );
  ...
  function injectCarSummaryOnly() {
    ...
    var actionFooter = document.querySelector('[data-testid="ancillaries-action-footer"]').parentElement;
