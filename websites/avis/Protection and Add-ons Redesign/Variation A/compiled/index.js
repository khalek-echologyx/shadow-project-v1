(function () {
  ...
  function injectProtectionLayout() {
    ...
    // Add opt out section
    var optOutSectin = '<div class="opt-out-section" id="avis-opt-out-container-a">' +
  ...
  function observeDOM() {
    ...
    observer.observe(document.querySelector('[data-testid="ancillaries-bundles-container"]'), {
      childList: true,
      subtree: true,
    });
  }
