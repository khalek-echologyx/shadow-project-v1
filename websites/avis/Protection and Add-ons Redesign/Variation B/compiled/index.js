(function () {
  ...
  window.updateAvisCarSummary = function () {
    ...
    if (!hasProtectionBundles && originalBundlesContainer) {
      ...
      originalBundlesContainer.style.display = 'block';
  ...
  if (!window.avisInterceptorSetup) {
    ...
    window.fetch = function () {
      ...
      var isPriceCalc = urlStr.indexOf("/web/reservation/price/calculate") !== -1;
  ...
  function injectProtectionLayout() {
    ...
    poll(
      function () {
        return document.querySelector('[data-testid="single-protections-list-section-container"]') &&
    ...
    poll(
      function () { return $('button[data-testid="action-footer-cta-button"]').length > 0; },
      function () {
