...
.MVT-36 .mvt-36-summary-prot-item .sum-prot-item-desc {
  color: #1ea238 !important;
}
.MVT-36 .mvt-36-summary-prot-item .sum-prot-item-desc svg {
  margin-right: 2px;
}
.MVT-36
...
.MVT-36 .selected-prot-bundle-title {
  color: #1ea238 !important;
}
.MVT-36 .accordion-wrapper {
  padding: 4px 24px;
}
.MVT-36 .mvt-36-summary-regular-item {
  display: flex;
  justify-content: space-between;
  align-items: center;
...
.MVT-36 .mvt-36-summary-regular-item .saving-desc {
  padding: 4px 0;
}
...
.MVT-36 .intial-prot-cards .protection-item {
  display: flex;
...
.MVT-36 .intial-prot-cards .protection-item:hover {
  border-color: #393636;
}
.MVT-36 .intial-prot-cards .protection-item .protection-item-info {
  display: flex;
  justify-content: space-between;
  align-items: center;
}
...
.MVT-36 .intial-prot-cards .protection-item .protection-item-info .radio-outer {
...
.MVT-36 .intial-prot-cards .protection-item.selected {
  border-color: #000;
}
.MVT-36 .intial-prot-cards .protection-item.selected .card-radio {
  background: #fff;
  border-color: #000;
}
.MVT-36 .intial-prot-cards .protection-item.selected .card-radio .radio-inner {
  width: 16px;
  height: 16px;
  background: #000;
  border-radius: 50%;
...
.MVT-36 .intial-prot-cards .static-no-prot-card {
  display: flex;
  flex-direction: column;
  gap: 16px;
  border: 2px solid #d7dbe0;
...
.MVT-36 .intial-prot-cards .static-no-prot-card:hover {
  border-color: #393636;
}
.MVT-36 .intial-prot-cards .static-no-prot-card .protection-item-info {
  display: flex;
  justify-content: space-between;
  align-items: center;
}
...
.MVT-36 .intial-prot-cards .static-no-prot-card.selected {
  border-color: #000;
}
.MVT-36 .intial-prot-cards .static-no-prot-card.selected .card-radio {
  background: #fff;
  border-color: #000;
}
.MVT-36
  .intial-prot-cards
  .static-no-prot-card.selected
  .card-radio
  .radio-inner {
  width: 16px;
  height: 16px;
...
.MVT-36 .intial-prot-cards .static-no-prot-card .protection-item-actions {
  display: flex;
  justify-content: end;
  align-items: flex-end;
}
...
.MVT-36 .intial-prot-cards .static-no-prot-card.disabled {
  pointer-events: none;
  opacity: 0.5;
}
.MVT-36 .prot-cards {
...
.MVT-36 .prot-cards [data-code="No Protection"] {
...
.MVT-36 .prot-card.prot-card--extra {
  display: none;
}
.MVT-36 .prot-card.selected {
  border: 2px solid #393636;
}
.MVT-36 .prot-card.selected .card-radio .radio-outer {
  background: #fff;
  border-color: #000;
}
.MVT-36 .prot-card.selected .card-radio .radio-outer .radio-inner {
  width: 16px;
  height: 16px;
  background: #000;
  border-radius: 50%;
}
.MVT-36 .prot-card .card-info {
  display: flex;
  justify-content: space-between;
  align-items: center;
}
.MVT-36 .prot-card .card-info .card-title {
  font-size: 20px;
  font-weight: 700;
  line-height: 28px;
...
.MVT-36 .prot-card .card-radio {
  display: inline-block;
}
.MVT-36 .prot-card .card-radio .radio-outer {
  width: 24px;
  height: 24px;
  border-radius: 50%;
  border: 1.5px solid #000;
...
.MVT-36 .prot-card .card-features .feature-item {
  display: flex;
  gap: 8px;
}
.MVT-36 .prot-card .card-features .feature-item .feature-text {
  font-size: 14px;
  font-weight: 400;
  line-height: 20px;
  letter-spacing: 0.06px;
}
.MVT-36 .prot-card .card-actions {
  display: flex;
  justify-content: end;
  align-items: flex-end;
  margin-top: 16px;
}
.MVT-36 .prot-card .view-coverage {
  display: none;
  font-size: 14px;
  font-weight: 700;
  text-decoration: underline;
...
.MVT-36 .prot-card .price-info {
  font-size: 28px;
  font-weight: 500;
  line-height: 21px;
  letter-spacing: 0px;
}
.MVT-36 .prot-card .price-info .per-day-slash {
  display: inline;
  font-size: 16px;
  margin-left: -4px;
  vertical-align: middle;
}
.MVT-36 .prot-card .price-info .per-day-slash .per-day {
  vertical-align: middle;
}
.MVT-36 .prot-card:hover {
  border-color: #393636;
}
.MVT-36 .protection-items-section {
  display: grid;
  grid-template-columns: repeat(2, 1fr);
  gap: 16px;
  max-height: 0px;
...
.MVT-36 .protection-items-section .protection-item {
  display: flex;
  flex-direction: column;
  gap: 16px;
  border: 2px solid #d7dbe0;
...
.MVT-36 .protection-items-section .protection-item .protection-item-info {
  display: flex;
  justify-content: space-between;
  align-items: center;
}
...
.MVT-36 .add-ons-section .add-on-bundles-section {
  display: none;
}
.MVT-36 .add-ons-section .add-on-bundles-section .add-on-bundles-content {
  display: flex;
  flex-direction: column;
  gap: 16px;
}
...
.MVT-36 .add-on-card .card-header {
  display: flex;
  align-items: center;
  gap: 8px;
}
.MVT-36 .add-on-card:hover {
  border-color: #000;
}
.MVT-36 .add-on-card .add-on-icon {
  display: flex;
  gap: 8px;
  align-items: center;
  justify-content: center;
...
.MVT-36 .add-on-card .add-on-info .add-on-title {
  margin: 0;
  font-weight: 500;
  font-size: 20px;
  line-height: 28px;
...
.MVT-36 .add-on-card .add-on-info .add-on-price {
  font-size: 14px;
  font-weight: 800;
  margin: 0;
  color: #000;
}
.MVT-36 .add-on-card .card-footer {
  display: flex;
  align-items: flex-end;
  flex-wrap: wrap;
  justify-content: space-between;
...
.MVT-36 .add-on-card .card-footer .price-info {
  font-size: 28px;
  font-weight: 500;
  line-height: 21px;
  letter-spacing: 0px;
}
.MVT-36 .add-on-card .card-footer .price-info .est-text {
  font-size: 16px;
}
.MVT-36 .add-on-card .card-footer .price-info .per-day-slash {
  display: inline;
  font-size: 16px;
  margin-left: -4px;
  vertical-align: middle;
}
.MVT-36 .add-on-card .card-footer .price-info .per-day-slash .per-day {
  vertical-align: middle;
}
.MVT-36 .add-on-card .add-on-actions {
  display: flex;
  align-items: flex-end;
  gap: 24px;
}
.MVT-36 .add-on-card .add-on-actions .add-on-details {
  font-size: 14px;
  font-weight: 800;
  color: #000;
  text-decoration: underline;
...
.MVT-36 .add-on-card .add-on-actions .quantity-selector-wrapper {
  display: flex;
  flex-direction: column;
  gap: 8px;
}
.MVT-36 .add-on-card .add-on-actions .quantity-selector {
  display: flex;
  align-items: center;
  gap: 8px;
}
.MVT-36 .add-on-card .add-on-actions .quantity-selector .quantity-minus,
.MVT-36 .add-on-card .add-on-actions .quantity-selector .quantity-plus {
  border: 1px solid #c7c5c5;
  border-radius: 4px;
  padding: 4px;
  background-color: #fff;
...
.MVT-36 .add-on-card .add-on-actions .quantity-selector .quantity-input {
...
.MVT-36 .add-on-card .add-on-actions .add-on-toggle {
  position: relative;
  display: inline-flex;
  align-items: center;
  gap: 8px;
...
.MVT-36 .add-on-card .add-on-actions .add-on-toggle input {
  opacity: 0;
  width: 0;
  height: 0;
  position: absolute;
}
.MVT-36 .add-on-card .add-on-actions .add-on-toggle .toggle-label-text {
  font-size: 14px;
  font-weight: 400;
  color: #524d4d;
  white-space: nowrap;
...
.MVT-36 .add-on-card .add-on-actions .add-on-toggle .checkbox-mark {
  display: flex;
  align-items: center;
  justify-content: center;
  width: 16px;
...
.MVT-36 .add-on-card .add-on-actions .add-on-toggle .checkbox-mark:after {
  content: "";
  display: none;
  width: 5px;
  height: 9px;
...
.MVT-36 .add-on-card .add-on-details-content .add-on-details-content-text {
  margin: 0;
}
.MVT-36 .add-on-card .add-on-details-content.expend {
  height: auto !important;
  margin-top: 10px;
}
@media (max-width: 768px) {
...
.MVT-36 .add-on-card.included input,
.MVT-36 .add-on-card.included .toggle-label-text,
.MVT-36 .add-on-card.included .checkbox-mark {
  display: none !important;
  pointer-events: none !important;
}
...
.MVT-36 .add-on-card.default button.quantity-minus {
  pointer-events: none !important;
}
.MVT-36 .add-on-card.ab-min-qty button.quantity-minus {
  pointer-events: none;
}
.MVT-36 .add-on-card.ab-min-qty button.quantity-plus {
  border: 1px solid #000 !important;
  color: #000 !important;
}
.MVT-36
  .add-on-card:not(.ab-min-qty):not(.ab-max-qty):not(.default)
...
.MVT-36 .add-on-card.ab-max-qty button.quantity-minus {
  color: #fff !important;
  background-color: rgb(212, 0, 42) !important;
  border-color: rgb(212, 0, 42) !important;
}
.MVT-36 .add-on-card.ab-max-qty button.quantity-plus {
  border: 1px solid #c7c7c7 !important;
  color: #c7c7c7 !important;
  pointer-events: none !important;
}
.MVT-36 .add-ons-footer {
  margin-top: 16px;
}
.MVT-36 .add-ons-footer .add-on-btn-all-packages {
  font-family: "AvisSans", "AvisSans Fallback", sans-serif;
  border: none;
  font-size: 14px;
  line-height: 14px;
...
.MVT-36 [data-testid="action-footer-total-amount"] {
  pointer-events: none !important;
}
.MVT-36 .mvt-36-disabled {
  color: #000 !important;
...
@media (max-width: 767px) {
  .MVT-36 #avis-pwp-block .pwp-row {
    flex-direction: column;
  }
}
.MVT-36 div.MuiPaper-root:has([data-testid="pay-with-points-container"]) {
  display: none !important;
}
`;
...
var addOnItemsSvgObj$1 = (addOnItemsSvgObj = {
  ...
  SNC: '<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">\
    <path d="M22.7144 14.0549C22.7385 14.1442 22.7447 14.2374 22.7325 14.3291C22.7204 14.4208 22.6902 14.5094 22.6437 14.5894C22.5972 14.6693 22.5354 14.7393 22.4617 14.7952C22.388 14.8511 22.3039 14.8918 22.2144 14.915L19.5044 15.635L21.9744 17.0649C22.0554 17.1113 22.1265 17.1731 22.1835 17.2471C22.2405 17.321 22.2823 17.4057 22.3065 17.4958C22.3307 17.586 22.3367 17.6802 22.3243 17.7727C22.312 17.8652 22.2814 
7592 8.47799 12.3807 8.47998 12C8.47818 11.6196 8.53898 11.2417 8.65997 10.8811L4.96002 8.75098C4.48582 9.76846 4.24004 10.8774 4.23999 12ZM9.89001 12C9.88948 12.5608 10.1113 13.099 10.5068 13.4966C10.9023 13.8941 11.4392 14.1187 12 14.1211C12.5623 14.1206 13.1013 13.8967 13.4988 13.499C13.8963 13.1013 14.1197 12.5623 14.12 12C14.1195 11.438 13.8959 10.8993 13.4984 10.502C13.1009 10.1046 12.562 9.88137 12 9.8811C11.4395 9.88322 10.9026 10.1074 10.5071 10.5046C10.1116 10.9018 9.88975 11.4395 9.89001 12ZM12.71 8.54102C13.4593 8.69854 14.1389 9.09074 14.65 9.66089L18.34 7.53198C17.696 6.61009 16.8585 5.83985 15.8862 5.2749C14.9138 4.70996 13.8299 4.36392 12.71 4.26099V8.54102ZM5.65997 7.521L9.35999 9.65991C9.86851 9.08659 10.5492 8.69374 11.3 8.54004V4.25903C10.1804 4.36391 9.09672 4.7096 8.12323 5.27246C7.14974 5.83532 6.30944 6.60302 5.65997 7.521Z" fill="black"/>\
    </svg>',
});
...
function preferredPoint() {
  ...
  var CFG = {
    ...
    selectors: {
      ...
      bookingSummaryRoot:
        '[data-testid="rental-summary-title"], aside, .booking-summary',
      // Multiple selectors comma-separated — Avis renders the points value
      // in different places depending on page state.
      domPointsValue:
        '[data-testid="points-value"], [data-testid="profile-menu-profile-btn"]',
    ...
    copy: {
      ...
      freeDayPointsNeeded:
        "You would need {{forFreeDay}} of Avis Preferred Points for a free day or {{forFreeTrip}} for entire rental.",
      selectLabel: "Select",
  ...
  (function patchFetch() {
    ...
    window.fetch = function (input, init) {
      ...
      try {
        ...
        init = init || {};
        if (
          CFG.interceptPatterns.calculate.test(url) &&
          init.body &&
          ...
          try {
            ...
            if (pwpCodes.length) {
              parsed.addOnItems = Array.isArray(parsed.addOnItems)
                ? parsed.addOnItems.slice()
                : [];
              ...
              var existingCodes = parsed.addOnItems.map(function (i) {
                return i.code;
              });
        ...
        if (
          CFG.interceptPatterns.create.test(url) &&
          (pwpHasFreeday || pwpHasAddOnCodes) &&
          init.body &&
          typeof init.body === "string"
        ) {
          try {
            ...
            if (pwpHasAddOnCodes) {
              ...
              body.addOnItems = Array.isArray(body.addOnItems)
                ? body.addOnItems.slice()
                : [];
              ...
              var existingCodes = body.addOnItems.map(function (i) {
                return i.code;
              });
  ...
  if (!CFG.pageMatch.test(location.pathname)) {
    console.log(
      "[pwp] not on review-and-book — script idle. Current path:",
      location.pathname,
    );
    return;
  }
  ...
  function isNamRegion() {
    return /(^|\.)avis\.com$/i.test(location.hostname);
  }
  ...
  function getRentalDays() {
    ...
    var py = Number(s.pickupYear),
      pm = Number(s.pickupMonth),
      pdy = Number(s.pickupDay);
    var ry = Number(s.returnYear),
      rm = Number(s.returnMonth),
      rdy = Number(s.returnDay);
  ...
  function buildCalculateUrl() {
    var corrId = "";
    try {
      corrId = sessionStorage.getItem("correlationIdentifier") || "";
    } catch (e) {}
    var qs =
      "context.locale=en-US" +
      "&context.domainCountry=US" +
      (corrId
        ? "&context.correlationIdentifier=" + encodeURIComponent(corrId)
        : "") +
      "&device=WEB";
  ...
  function readLoyaltyFromFiber() {
    var pred = function (o) {
      return o && o.profileNumber && o.points != null;
    };
    var scoped = fiberFromElement(
      $('[data-testid="profile-menu-container"]'),
      pred,
    );
    if (scoped) return scoped;
    return (
      fiberHookSearch(pred) ||
      fiberSearch(function (o) {
        return o && o.profileNumber && o.points != null && o.status;
      }) ||
      null
    );
  }
  function readProtectionsFromFiber() {
    var pred = function (o) {
      return o && (o.freedayItem || o.redemptionStatus);
    };
    var scoped =
      fiberFromElement($('[data-testid="rc-paymentoptions-title"]'), pred) ||
  ...
  function readStore() {
    try {
      return JSON.parse(sessionStorage.getItem(CFG.ss.reservationStore)) || {};
    } catch (e) {
      return {};
    }
  }
  function writeStore(patch) {
    ...
    try {
      sessionStorage.setItem(CFG.ss.reservationStore, JSON.stringify(existing));
    } catch (e) {}
  }
  function persistProtections(data) {
    try {
      sessionStorage.setItem(CFG.ss.protectionsData, JSON.stringify(data));
    } catch (e) {}
    writeStore({ protectionsData: data });
  }
  function persistLoyalty(loyalty) {
    try {
      sessionStorage.setItem(CFG.ss.loyaltySummary, JSON.stringify(loyalty));
    } catch (e) {}
  ...
  function getCodeQuantity(code) {
    if (!code) return 1;
    var raw = sessionStorage.getItem("reservation.store");
    var s = raw ? JSON.parse(raw).state || {} : {};
    var codes = String(s.addOnItems || "")
      .split(",")
      .map(function (c) {
        return c.trim();
      })
      .filter(Boolean);
    var qtys = String(s.addOnItemsQuantity || "")
      .split(",")
      .map(function (q) {
        return q.trim();
      });
    ...
    if (i === -1) return 1;
    var rawQ = qtys[i];
    if (rawQ == null || rawQ === "false" || rawQ === "") return 1;
    var n = parseInt(rawQ, 10);
    return isNaN(n) || n < 1 ? 1 : n;
  }

  function getAddOnPointsCost(code) {
    var elig = getAddOnEligibilityMap();
    var info = elig[code];
    if (!info) return 0;
    var perItem = Number(info.pointValuePoints) || 0;
    return perItem * getCodeQuantity(code);
  }
  ...
  function isDayEligible(protections) {
    ...
    var explicitlyNotRedeemable = !!(
      protections.redemptionStatus &&
  ...
  function isRedeemableNow(loyalty, protections) {
    var canRedeem = !!(
      protections.redemptionStatus && protections.redemptionStatus.isRedeemable
    );
  ...
  function refreshDayPicker() {
    ...
    var loyalty =
      readLoyaltyFromOverride() ||
      readLoyaltyFromStore() ||
      readLoyaltyFromDom() ||
      readLoyaltyFromFiber();
    var protections =
      readProtectionsFromOverride() ||
      (readStore().state || {}).protectionsData;
    if (!loyalty || !protections || !isRedeemableNow(loyalty, protections))
      return;
  ...
  function styleOnce() {
    ...
    var css =
      ...
      "#avis-pwp-block .pwp-eyebrow{font-family:" +
      FONT_HEADLINE +
      ";font-size:24px;" +
      "font-weight:400;line-height:36px;letter-spacing:-0.8px;color:#000;" +
      "text-transform:uppercase;margin:0;}" +
      "#avis-pwp-block .pwp-title{font-family:" +
      FONT_BODY +
      ";font-size:18px;" +
      "font-weight:500;line-height:28px;color:#000;margin:0;}" +
      "#avis-pwp-block .pwp-points-value{font-family:" +
      FONT_HEADLINE +
      ";font-size:24px;" +
      "font-weight:400;line-height:36px;color:" +
      AVIS_RED +
      ";margin:0 0 0 8px;" +
      "white-space:nowrap;}" +
      "#avis-pwp-block .pwp-note{font-family:" +
      FONT_BODY +
      ";font-size:14px;" +
      ...
      "#avis-pwp-block .pwp-picker label{font-family:" +
      FONT_BODY +
      ";font-size:14px;" +
      "color:#000;font-weight:500;}" +
      "#avis-pwp-block .pwp-picker select{font-family:" +
      FONT_BODY +
      ";padding:12px 14px;" +
      "border:1px solid #c4c4c4;border-radius:8px;font-size:14px;background:#fff;" +
      "cursor:pointer;min-width:240px;color:#000;}" +
      "#avis-pwp-block .pwp-picker select:focus{outline:2px solid " +
      AVIS_RED +
      ";outline-offset:1px;}" +
      "#avis-pwp-block .pwp-picker select:disabled{opacity:0.55;cursor:not-allowed;}" +
      "#avis-pwp-block .pwp-pts{font-family:" +
      FONT_HEADLINE +
      ";font-size:18px;" +
      "font-weight:400;color:" +
      AVIS_RED +
      ";white-space:nowrap;}" +
      "#avis-pwp-block .pwp-busy{font-family:" +
      FONT_BODY +
      ";font-size:13px;color:#666;margin-top:8px;}" +
      "#avis-pwp-block .pwp-error{font-family:" +
      FONT_BODY +
      ";font-size:13px;color:#a00;margin-top:8px;}";
  ...
  function renderHeader(loyalty) {
    return (
      ...
      '<h4 class="pwp-eyebrow" data-testid="points-heading">' +
      escapeHtml(CFG.copy.preferredPointsLabel) +
      "</h4>" +
      '<div class="pwp-title" data-testid="pay-with-points-title">' +
      escapeHtml(CFG.copy.sectionHeading) +
      "</div>" +
      "</div>" +
      '<h4 class="pwp-points-value" data-testid="points-value">' +
      fmtNum(loyalty.points || 0) +
      " Points</h4>" +
      "</div>"
    );
  }
  ...
  function renderRedeemable(loyalty, protections) {
    ...
    var rentalPeriod =
      bookingDays > 0 ? Math.min(backendAllowed, bookingDays) : backendAllowed;
    ...
    var options =
      '<option value="0">' + escapeHtml(CFG.copy.selectLabel) + "</option>";
    ...
    return (
      ...
      '<label for="avis-pwp-days">' +
      escapeHtml(CFG.copy.daysToRedeem) +
      "</label>" +
      ...
      "</div>" +
      '<span class="pwp-pts">' +
      tpl(CFG.copy.pointsPerDay, { n: fmtNum(perDayPoints) }) +
      "</span>" +
      "</div>"
    );
  }
  ...
  function renderNotRedeemable(protections) {
    ...
    return (
      '<div class="pwp-note" data-testid="pay-with-points-description-points">' +
      escapeHtml(note) +
      "</div>"
    );
  }
  ...
  function renderBlock(loyalty, protections) {
    ...
    var inner =
      ...
      (canRedeem
        ? renderRedeemable(loyalty, protections)
    ...
    var anchor =
      $(CFG.selectors.flightDetailsAnchor) ||
    ...
    callCalculate(qty)
      .then(function (resp) {
        ...
        window.dispatchEvent(
          new CustomEvent("avis:pwp:changed", {
  ...
  function syncSummary(calc) {
    ...
    if (calc.savings) {
      ...
      if (sd) {
        var existing = sd.querySelector(
          ":scope > .MuiAccordionDetails-root, :scope > #pwp-summary-savings",
        );
        if (existing)
          try {
            existing.remove();
        ...
        function row(label, amount) {
          ...
          return (
            '<div class="pwp-summary-row" style="display:flex;justify-content:space-between;color:#736d6d;font-size:14px;line-height:20px;padding:4px 0;">' +
            "<span>" +
            escapeHtml(label) +
            "</span>" +
            "<span>" +
            escapeHtml(formatPrice(cc, Number(amount).toFixed(2))) +
            "</span>" +
            "</div>"
          );
        }
  ...
  function updateBookingSummary(calc) {
    syncSummary(calc);
  }
  ...
  function syncEmptyAddOnsPlaceholder(calc) {
    var hasItems = false;
    if (calc && Array.isArray(calc.addOnItems) && calc.addOnItems.length > 0)
      hasItems = true;
    if (
      !hasItems &&
      Array.isArray(calc && calc.protectionItems) &&
      calc.protectionItems.length > 0
    )
      hasItems = true;
    // Belt-and-braces: also count our injected rows
    if (
      !hasItems &&
      document.querySelectorAll('[id^="pwp-injected-paddon-"]').length > 0
    )
      hasItems = true;
    ...
    while (placeholder && placeholder.nodeType !== 1)
      placeholder = placeholder.nextSibling; // skip whitespace
    if (!placeholder) return;
    if (
      !/added any protections or add[-\s]?ons/i.test(
  ...
  function syncPointsPaidRows(calc) {
    ...
    document
      .querySelectorAll('[id^="pwp-injected-paddon-"]')
      .forEach(function (r) {
        try {
          r.remove();
        } catch (e) {}
    ...
    calc.addOnItems.forEach(function (item) {
      ...
      var price =
        Number(item.netSubtotal != null ? item.netSubtotal : item.amount) || 0;
      ...
      if (existing) {
        ...
        if (existing.classList.contains("mvt-36-summary-prot-item")) {
          ...
          if (amountWrapper && amountWrapper !== firstChild) {
            var amountSpan =
              amountWrapper.querySelector("span") || amountWrapper;
            amountSpan.textContent = isGSO
              ? "Market Price"
              : formatPrice(cc, price.toFixed(2));
          }
        }
  ...
  function findProtectionsAddOnsContainer() {
    ...
    if (pa) {
      ...
      // the row container.
      var details = pa.querySelector(
        ":scope > .MuiAccordionDetails-root, :scope .MuiAccordionDetails-root",
      );
      return {
        container: details || pa,
        source: details ? "mui-accordion-details" : "aria-label",
      };
    }

    var firstDesc = document.querySelector(
      '[data-testid^="cost-"][data-testid$="-description"]',
    );
    if (firstDesc) {
      var probe = firstDesc;
      for (var i = 0; i < 6; i++) {
    ...
    if (btn) {
      ...
      if (accordion) {
        ...
        if (details2)
          return { container: details2, source: "accordion-details" };
  ...
  function findProtAddOnRowByCode(code) {
    ...
    for (var i = 0; i < mvtRows.length; i++) {
      if ((mvtRows[i].textContent || "").indexOf("(" + code + ")") > -1)
        return mvtRows[i];
    }
    var descRows = document.querySelectorAll(
      '[data-testid^="cost-"][data-testid$="-description"]',
    );
    for (var j = 0; j < descRows.length; j++) {
      if ((descRows[j].textContent || "").indexOf("(" + code + ")") > -1)
        return descRows[j];
    }
    return null;
  }
  ...
  function injectProtectionsAddOnRow(item, price, cc, isStandard, qty) {
    ...
    if (!found) {
      console.warn(
        "[pwp] Protections & Add-ons container not found — cannot inject row for",
        item.code,
      );
      return;
    }
    ...
    descSpan.className =
      "checkout-redesign MuiTypography-root MuiTypography-bodySmallRegular sum-prot-item-desc";
    descSpan.style.cssText = isStandard
      ? "color:#524d4d !important;"
      : "color:#1ea238 !important;";
    descSpan.innerHTML =
      '<svg xmlns="http://www.w3.org/2000/svg" width="14" height="10" viewBox="0 0 14 10" fill="none" style="margin-right:4px;vertical-align:middle;">' +
    ...
    console.log(
      "[pwp] injected protections row for",
      item.code,
      "into",
      found.source,
    );
  ...
  function ensureProtectionsObserver() {
    ...
    var stable =
      document.querySelector('[data-testid="rental-summary-wrapper"]') ||
  ...
  function getAddOnDescription(code) {
    ...
    var cards = document.querySelectorAll(
      '.add-on-card, [data-testid="single-addons-item-card-container"]',
    );
    ...
    for (var p = 0; p < prices.length; p++) {
      if (prices[p].code === code && prices[p].description)
        return prices[p].description;
    }
  ...
  function renderAppliedPointsSection() {
    ...
    (__pwpState.payWithPointsCodes || []).forEach(function (code) {
      ...
      var perItem = Number(elig[code].pointValuePoints) || 0;
      var label = getAddOnDescription(code); // e.g. "Child Safety Seat (CSS)"
      if (qty > 1) label = qty + " × " + label; // "2 × Child Safety Seat (CSS)"
      items.push({
        label: label,
        points: perItem * qty,
      });
    ...
    var totalPoints = items.reduce(function (sum, i) {
    ...
    var rowsHTML = items
      .map(function (it) {
        return (
          ...
          escapeHtml(it.label) +
          "</span>" +
          '<span style="color:#1ea238;font-weight:500;white-space:nowrap;">' +
          fmtNum(it.points) +
          " Points</span>" +
          "</div>"
        );
    ...
    var bodyHTML =
      '<div class="pwp-app-pts-body" style="padding:4px 0 12px 0;">' +
      rowsHTML +
      "</div>";
    ...
    if (!wrapper) {
      console.warn(
        "[pwp] rental-summary-wrapper not found; cannot render Applied Preferred Points section",
      );
      return;
    }
  ...
  document.body.addEventListener(
    ...
    function (e) {
      ...
      var btn =
        t.classList &&
        (t.classList.contains("quantity-plus") ||
          t.classList.contains("quantity-minus"))
          ? t
          : t.closest && t.closest(".quantity-plus, .quantity-minus");
      if (!btn) return;
  ...
  function getStateCommittedPoints() {
    var fd = getFreedayItem();
    var freedayCost =
      __pwpState.quantity > 0 && fd
        ? __pwpState.quantity * (Number(fd.perDayPoints) || 0)
        : 0;
    var addOnCost = 0;
    var elig = getAddOnEligibilityMap();
    (__pwpState.payWithPointsCodes || []).forEach(function (code) {
      if (elig[code]) addOnCost += getAddOnPointsCost(code) || 0;
    });
  ...
  function updatePointsAppliedIndicator(calc) {
    ...
    node.style.cssText =
      "color:#1ea238;font-size:14px;font-weight:500;margin-right:16px;" +
    ...
    if (!inserted) {
      ...
      console.warn(
        "[pwp] could not locate action-footer anchor; pinning indicator to viewport",
      );
      node.style.cssText +=
        ";position:fixed;bottom:16px;right:200px;z-index:9999;background:#fff;padding:4px 8px;border-radius:4px;box-shadow:0 1px 4px rgba(0,0,0,0.2);";
  ...
  function callCalculate(qty) {
    ...
    if (!template)
      return Promise.reject(new Error("no calculate template available yet"));
  ...
  function buildAddOnItemsForCalc(pwpCodes) {
    ...
    var existing = items.map(function (i) {
      return i.code;
    });
    pwpCodes.forEach(function (code) {
  ...
  function buildCalculateBodyFromStore() {
    ...
    if (s.couponCode)
      discountCodes.push({ type: "COUPON", value: s.couponCode });
  ...
  window.__pwpQaMode = function (opts) {
    ...
    window.__pwpForceProtections = opts.protections || {
      freedayItem: {
        perDayPoints: perDay,
        rentalPeriod: actualDays,
        totalPoints: perDay * actualDays,
      },
      redemptionStatus: { isRedeemable: true },
    };
    window.__pwpRerender();
    return (
      "[pwp] QA mode on — points=" +
      window.__pwpForcePoints +
      ", days=" +
      actualDays
    );
  };
  ...
  window.__pwpRerender = function () {
    ...
    if (existing) existing.remove();
    document
      .querySelectorAll('[data-testid="pay-with-points-container"]')
      .forEach(function (el) {
  ...
  window.__pwpDiagnose = function () {
    ...
    var report = {
      ...
      pointsOverride:
        window.__pwpForcePoints != null ? window.__pwpForcePoints : null,
      loyalty: loyalty
        ? {
            points: loyalty.points,
            status: loyalty.status,
            profile: loyalty.profileNumber,
          }
        : null,
      ...
      canRedeemNow:
        loyalty && protections ? isRedeemableNow(loyalty, protections) : false,
      ...
      committedPointsTotal: loyalty && protections ? getCommittedPoints() : 0,
    };
  ...
  function restorePayWithPointsState() {
    ...
    var valid = stored.filter(function (c) {
  ...
  function boot() {
    ...
    var hasUsable = function (p) {
      return p && (p.freedayItem || p.redemptionStatus);
    };
    ...
    if (protectionsOverride) {
      ...
      pExtras = fetchExtrasIfMissing().then(function () {
        if (
          __pwpState.extras &&
          (__pwpState.extras.freedayItem || __pwpState.extras.redemptionStatus)
        ) {
          return {
    ...
    pExtras = pExtras.then(function (p) {
      if (p) persistProtections(p);
      return p;
    });
      ...
      waitFor(
        ...
        .then(function () {
          ...
          if (isDayEligible(protections)) {
            ...
            console.log(
              "[pwp] day redemption not available for this rate — skipping PWP card, enhancing add-on toggles only",
            );
          }
          ...
          if (
            ...
            callCalculate(__pwpState.quantity)
              ...
              .catch(function (err) {
                ...
                console.warn(
                  "[pwp] restore calculate failed, falling back to local state render",
                  err,
                );
                renderAppliedPointsSection();
  ...
  function getAddOnEligibilityMap() {
    ...
    var items =
      (__pwpState.extras && __pwpState.extras.addOnItems) ||
  ...
  function getFreedayItem() {
    if (__pwpState.extras && __pwpState.extras.freedayItem)
      return __pwpState.extras.freedayItem;
  ...
  function fetchExtrasIfMissing() {
    ...
    if (
      ad.addOnItems &&
      ad.addOnItems.some(function (i) {
        return i.loyalty && i.loyalty.pointValuePoints;
      })
    ) {
    ...
    console.log(
      "[pwp] fetching /web/reservation/extras to populate addOnsData…",
    );
      ...
      .then(function (r) {
        ...
        return r.json().then(function (j) {
          ...
          var newProtections = {
            ...
            redemptionStatus:
              j.redemptionStatus || existing.redemptionStatus || null,
            protectionItems:
              j.protectionItems || existing.protectionItems || [],
            protectionBundles:
              j.protectionBundles || existing.protectionBundles || [],
          ...
          writeStore({
            addOnsData: newAddOnsData,
            protectionsData: newProtections,
          });
          var withLoyalty = (j.addOnItems || []).filter(function (i) {
            return i.loyalty && i.loyalty.pointValuePoints;
          }).length;
          console.log(
            "[pwp] extras fetched —",
            ...
            "isRedeemable=" +
              (newProtections.redemptionStatus
                ? newProtections.redemptionStatus.isRedeemable
                : "unknown"),
          );
  ...
  function getCommittedPoints(loyalty, protections) {
    ...
    var addOnCost = 0;
    (__pwpState.payWithPointsCodes || []).forEach(function (code) {
      addOnCost += getAddOnPointsCost(code);
    });
    return freedayCost + addOnCost;
  }
  ...
  function findAddOnCards() {
    var sel =
      '.add-on-card[data-code], .add-on-card, [data-testid="single-addons-item-card-container"]';
  ...
  function enhanceAddOnCards(loyalty, protections) {
    ...
    var committed = getCommittedPoints();
    ...
    findAddOnCards().forEach(function (card) {
      ...
      var thisCost = getAddOnPointsCost(code);
      var ownCost = isOn ? thisCost : 0;
      var canAfford = balance - (committed - ownCost) >= thisCost;
      ...
      var addToTrip = card.querySelector(
        '.add-on-toggle, [data-testid="single-addons-item-add-to-trip-btn"], .add-on-actions, .card-footer',
      );
    ...
    if (stateChanged) {
      writeStore({
        payWithPointsCodes: (__pwpState.payWithPointsCodes || []).slice(),
      });
      if (__pwpState.lastCalculateResponse) {
        syncSummary(__pwpState.lastCalculateResponse);
      } else {
        if (typeof renderAppliedPointsSection === "function")
          renderAppliedPointsSection();
        if (typeof updatePointsAppliedIndicator === "function")
          updatePointsAppliedIndicator(null);
      }
    }
  }
  ...
  function onAddOnPointsToggle(code, isOn) {
    ...
    const allMoneyToggles = document.querySelectorAll(
      ".add-on-toggle input[type='checkbox']",
    );
    ...
    var thisToggle = document.querySelector(
      '.pwp-addon-pts-toggle input[data-pwp-code="' + code + '"]',
    );
    ...
    callCalculate(__pwpState.quantity)
      ...
      .catch(function (err) {
        ...
        if (isOn) {
          ...
          if (__pwpState.payWithPointsCodes.indexOf(code) === -1)
            __pwpState.payWithPointsCodes.push(code);
        }
        var loy2 =
          readLoyaltyFromOverride() ||
          readLoyaltyFromStore() ||
...
(() => {
  ...
  async function getProtectionAndAddOnsData(dataKey, pickupLocation) {
    let res = await fetch(
      (isBeta ? "https://beta.avis.com" : "https://www.avis.com") +
        "/content/admin/location.json/avis/en_us/" +
        dataKey +
        "/" +
        pickupLocation +
        ".json",
  ...
  async function getExtrasData(payload, corelationalIdentifier) {
    try {
      let res = await fetch(
        (isBeta ? "https://beta.avis.com" : "https://www.avis.com") +
          "/web/reservation/extras?context.locale=en-US&context.domainCountry=US&context.correlationIdentifier=" +
  ...
  async function calculatePrice(payload, corelationalIdentifier) {
    let res = await fetch(
      (isBeta ? "https://beta.avis.com" : "https://www.avis.com") +
        "/web/reservation/price/calculate?context.locale=en-US&context.domainCountry=US&context.correlationIdentifier=" +
        corelationalIdentifier +
        "&device=WEB",
      {
        method: "POST",
  ...
  var protAndAddOnItemUI = function (
    ...
    return (
      '<div data-item-code="' +
      item.code +
      '" class="MuiBox-root mui-q27lzn mvt-36-summary-prot-item">' +
  ...
  var savingAndDisItemUI = function (desc, amount) {
    return (
      ...
      '<span class="item-desc saving-desc">' +
      desc +
      "</span>" +
      '<div class="item-amount"><span class="">' +
      amount +
      "</span></div>" +
      "</div>"
    );
  ...
  var taxAndFeesItemUI = function (desc, amount, code, currencyCode) {
    return (
      '<a href="' +
      (isBeta ? "https://beta.avis.com" : "https://www.avis.com") +
      "/en/customer-service/faqs/usa/fees-taxes#" +
      code +
      '" target="_blank" class="mvt-36-summary-regular-item tax-and-fees-item">' +
      '<span class="item-desc">' +
      desc +
      "</span>" +
      '<div class="item-amount"><span class="">' +
      getPriceWithCurrenty(currencyCode, amount) +
      "</span></div>" +
      "</a>"
    );
  };
  ...
  const savingAndDiscountUI = (currencyCode, calculateData) => {
    ...
    const formatExtrasSavings = getPriceWithCurrenty(
      currencyCode,
      extrasSavings,
    );
    const discountCodeSavings = Number(
      calculateData.savings.discountCodeSavings,
    );
    const formatDiscountCodeSavings = getPriceWithCurrenty(
      currencyCode,
      discountCodeSavings,
    );
    const memberCreditAmt = Number(calculateData.savings.memberCreditAmt);
    const formatMemberCreditAmt = getPriceWithCurrenty(
      currencyCode,
      memberCreditAmt,
    );
    // header price update
    ...
    const savingAndDisItemContainer = document.querySelector(
      '[aria-label="Savings & discounts"]',
    );
    if (savingAndDisItemContainer) {
      ...
      var savingAndDiscountUIWrapper =
        '<div id="mvt-36-summary-saving" class="accordion-wrapper">' +
        (payNowSavings
          ? savingAndDisItemUI("Pay Now Savings", formatPayNowSavings)
          : "") +
        (extrasSavings
          ? savingAndDisItemUI(
              "Protection & Add-ons Savings",
              formatExtrasSavings,
            )
          : "") +
        (discountCodeSavings
          ? savingAndDisItemUI(
              ...
              formatDiscountCodeSavings,
            )
          : "") +
        (memberCreditAmt
          ? savingAndDisItemUI("Member Credit", formatMemberCreditAmt)
          : "") +
        "</div>";
      if (!savingAndDisItemContainer.querySelector("#pwp-summary-savings")) {
        savingAndDisItemContainer.insertAdjacentHTML(
          "beforeend",
          savingAndDiscountUIWrapper,
        );
      }
    }
  };
  ...
  const taxAndFeesUI = (currencyCode, calculateData) => {
    ...
    const taxAndFeesItemContainer = document.querySelector(
      '[aria-label="Taxes & Fees"]',
    );
    if (taxAndFeesItemContainer) {
      ...
      var taxAndFeesUIWrapper =
        ...
        (taxAndFeesItems.length > 0
          ...
          : "") +
        "</div>";
      taxAndFeesItemContainer.insertAdjacentHTML(
        "beforeend",
        taxAndFeesUIWrapper,
      );
    }
  ...
  const removePwpToggle = (code) => {
    const addOnItemsWithPwpToggle = document.querySelectorAll(
      "#" + TEST_ID + " .pwp-addon-pts-toggle",
    );
    addOnItemsWithPwpToggle.forEach((item) => {
      const itemToggleInput = item.querySelector("input");
      if (
        itemToggleInput &&
        itemToggleInput.getAttribute("data-pwp-code") === code
      ) {
    ...
    if (noProtOrAddOnsTitle) {
      if (
        (noProtOrAddOnsTitle.textContent =
          "You have not added any protections or add-ons")
      ) {
  ...
  const initalSelectUI = async (
    ...
    const uiSelectedProtBundle = uiProtectionBundleCards.find(
      (card) => card.getAttribute("data-code") === selectedProtBundleName,
    );
    ...
    if (sessionData) {
      const newProtectionItems = windowPriceProtectionList.map((item) => {
        return {
          amount: extrasProtectionItemList.find((i) => i.code === item.code)
            .netTotal,
          chargeType: item.chargeType,
          code: item.code,
          description:
            protectionItems.find((i) => i.code === item.code).name || "",
          discount:
      ...
      const newAddOnItems = windowPriceAddOnList.map((item) => {
        ...
        return {
          ...
          discount:
            extrasAddOnsItemList.find((i) => i.code === item.code).discount ||
            0,
          grossSubtotal: extrasAddOnsItemList.find((i) => i.code === item.code)
            .grossSubtotal,
      ...
      sessionStorage.setItem(
        "reservation.store",
        JSON.stringify({ state: sessionData, version: 0 }),
      );
      ...
      // checkbox UI update
      const checkboxAddOnItems = document.querySelectorAll(
        "." + TEST_ID + " .add-on-card .add-on-toggle",
      );
  ...
  async function runReviewAndBook() {
    ...
    (function () {
      ...
      console.log("===> index.js:105 ~ attacching");
    ...
    const finalProtectionBundleList = protectionBundleList
      .filter((item) => {
        return extrasProtectionBundleList.some(
    ...
    var protBundleCardsHTML = (finalProtectionBundleList || [])
      .map(function (prot) {
        var protitem = prot.includedProtections.length
          ? prot.includedProtections
          : [];
        var featureItemsHTML =
          protitem.length > 0
            ? protitem
                .map(function (item) {
                  return (
    ...
    var staticNoProtectionCard =
      ...
      '<div class="price-info">' +
      getPriceWithCurrenty(currencyCode, 0) +
      ' <p class="per-day-slash">/<span class="per-day">day</span></p></div>' +
      "</div>" +
      "</div>";
    ...
    const singleEssentialBundleItemList =
      essentialProtBundle && essentialProtBundle.includedProtections.length
        ? essentialProtBundle.includedProtections
        : [];
    const includedEssentialProtItemList = finalProtectionItemList.filter(
      (item) => item.freeCDWIndicator === true || item.netSubtotal === 0,
    );
    const includedAddOnItemList = finalAddOnItemList.filter(
      (item) => item.freeCDWIndicator === true || item.netSubtotal === 0,
    );
    const margedIncludedItemList = [
      ...includedEssentialProtItemList,
      ...includedAddOnItemList,
    ];
    ...
    if (showBundle) {
      var essProtItems =
        essentialProtBundle.includedProtections &&
        essentialProtBundle.includedProtections.length
          ? essentialProtBundle.includedProtections
          : [];
      var essProtFeaturesHTML = essProtItems
        .map(function (item) {
          return (
            '<div class="feature-item">' +
            '<div class="feature-icon">' +
      ...
      staticEssentialProtCard =
        '<div class="prot-card" data-code="' +
        (essentialProtBundle.bundleName || "") +
        '">' +
        '<div class="card-body">' +
        '<div class="card-info">' +
        '<h3 class="card-title">' +
    ...
    var addOnItemCardsHTML = finalAddOnItemList
      .map(function (item) {
        ...
        return (
          ...
          (addOnItemsSvgObj$1[item.code] || addOnItemsSvgObj$1["FLB"]) +
          "</div>" +
          '<div class="add-on-info"><h4 class="add-on-title">' +
          item.name +
          "</h4></div>" +
          "</div>" +
          '<div class="card-footer">' +
          '<div class="price-info">' +
          (isGSO ? '<span class="est-text">Est. </span>' : "") +
          getPriceWithCurrenty(currencyCode, item.netSubtotal) +
          ' <p class="per-day-slash">/<span class="per-day">' +
          (isGSO ? "gal" : "day") +
          "</span></p></div>" +
          ...
          '<p class="add-on-details-content-text">' +
          item.description.html +
          "</p>" +
          "</div>" +
          "</div>" +
    ...
    var protSection =
      ...
      (finalProtectionBundleList.length > 2
        ? '<button type="button" class="btn-all-packages">View all protection packages</button>'
        : "") +
      "</div>" +
    ...
    function inject() {
      ...
      protectionBundleCards.forEach((card) => {
        card.addEventListener("click", async () => {
          ...
          const formateStoreAddOnItemsQuantity =
            storeAddOnItemsQuantity
              .split(",")
              .map((item) => item.trim())
              .filter(Boolean) || [];
          ...
          const organizedAddOnItems =
            formateStoreAddOnItems.map((item, index) => {
              return {
                code: item || "",
                quantity:
                  formateStoreAddOnItemsQuantity[index] === "false"
                    ? null
                    : Number(formateStoreAddOnItemsQuantity[index]) || 1,
              };
            }) || [];
          const calculatePayload = {
      ...
      addOnToggles.forEach((toggle) => {
        toggle.addEventListener("change", async (e) => {
          ...
          const organizedAddOnItems = codesArray.map((c, i) => ({
            code: c,
            quantity:
              quantityArray[i] === "false" ? null : Number(quantityArray[i]),
          }));
          ...
          const newAddOnItems = calculateAddOnItems.map((addOnItem) => {
            ...
            const matchedItem = finalAddOnItemList.find(
              (i) => i.code === addOnItem.code,
            );
            return {
      ...
      addOnQuantity.forEach((selector) => {
        ...
        minusBtn.addEventListener("click", async (e) => {
          ...
          const codesArray = currentCodes
            ...
            : [];
          const addOnItemsQuantity = store.state.addOnItemsQuantity || "";
          const addOnItemsQuantityArray = addOnItemsQuantity
            ? addOnItemsQuantity.split(",").map(function (c) {
                return c.trim();
              })
            : [];

          const currentBackupCodes = store.state.addOnItemsBackup || "";
          const backupCodesArray = currentBackupCodes
            ? currentBackupCodes
                .split(",")
                .map(function (c) {
                  return c.trim();
                ...
                .filter(Boolean)
            : [];
          const addOnItemsQuantityBackup =
            store.state.addOnItemsQuantityBackup || "";
          const backupQuantityArray = addOnItemsQuantityBackup
            ? addOnItemsQuantityBackup.split(",").map(function (c) {
                return c.trim();
              })
            : [];

          // Keep quantityArray in sync with codesArray length
          while (addOnItemsQuantityArray.length < codesArray.length) {
            addOnItemsQuantityArray.push("false");
          }
          addOnItemsQuantityArray.splice(codesArray.length);

          // Keep backupQuantityArray in sync with backupCodesArray length
          while (backupQuantityArray.length < backupCodesArray.length) {
            backupQuantityArray.push("false");
          }
          ...
          // Call calculatePrice with the updated addOnItems
          const addOnItems = codesArray.map((c) => ({
            code: c,
            quantity:
              addOnItemsQuantityArray[codesArray.indexOf(c)] === "false"
                ? null
      ...
      const addOnDetails = document.querySelectorAll(
        "#" + TEST_ID + " .add-on-details",
      );
      ...
      const addOnBtn = document.querySelector(
        "#" + TEST_ID + " .add-on-btn-all-packages",
      );
      ...
      if (btn && container) {
        btn.addEventListener("click", (e) => {
          ...
          btn.textContent = container.classList.contains("show-all")
      ...
      const btnItems = document.querySelector(
        "#" + TEST_ID + " .btn-all-packages-items",
      );
      const containerItems = document.querySelector(
        "#" + TEST_ID + " .protection-items-section",
      );
      ...
      const el =
        document.querySelector('[data-testid="rate-terms-accordion"]') ||
        document.querySelector(
          '[data-testid="category-expand-button-taxes-fees"]',
        );
      if (el) {
        ...
        if (nextEl) {
          const hasSavings = nextEl
            ? nextEl.textContent
              ? nextEl?.textContent?.toLowerCase().includes("savings")
              : false
            : false;
          const hasMaxDiscount = nextEl
            ? nextEl.textContent
              ? nextEl.textContent.includes("MAX DISCOUNT")
              : false
            : false;
      ...
      poll(
        ...
        () => {
          const existingPwpCard = document.querySelector(
            '[data-testid="pay-with-points-container"]',
          );
          if (existingPwpCard) {
