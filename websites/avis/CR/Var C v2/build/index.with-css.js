...
function preferredPoint() {
  ...
  function startCardEnhancer(loyalty, protections) {
    ...
    __pwpCardObserver.observe(document.body, {
      childList: true,
      subtree: true,
    });
  ...
  function watchRoute() {
    ...
    setInterval(function () {
      ...
      if (__pwpCardObserver) {
        try {
          __pwpCardObserver.disconnect();
        } catch (e) {}
        __pwpCardObserver = null;
      }
...
(() => {
  ...
  var taxAndFeesItemUI = function (desc, amount, code, currencyCode) {
    return (
      '<a href="https://www.avis.com/en/customer-service/faqs/usa/fees-taxes#' +
      code +
