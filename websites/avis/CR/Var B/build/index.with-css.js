...
(() => {
        ...
        wrapper.insertAdjacentHTML(
          ...
          protAndAddOnItemUI(
            ...
            getPriceWithCurrenty(
              currencyCode,
              item.netSubtotal ? item.netSubtotal.toFixed(2) : 0,
            ),
            item,
            item.quantity,
          ),
  ...
  async function runReviewAndBook() {
    ...
    var selectedItemForInitalSectionHTML =
      ...
      getPriceWithCurrenty(
        currencyCode,
        selectedItemForInitalSection.netSubtotal,
      ) +
      ' <p class="per-day-slash">/<span class="per-day">day</span></p></div>' +
    ...
    function inject() {
      ...
      // HIDE ORIGINAL PREFERRED POINT SECTION
      poll(
        () =>
        ...
        () => {
          ...
          if (existingPwpCard) {
            console.log("Original preferred section exist:", true);
