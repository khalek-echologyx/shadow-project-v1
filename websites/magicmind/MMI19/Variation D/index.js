(function () {
  ...
  const init = () => {
    ...
    productTitle.textContent = getExtantionText(productTitle.textContent?.toLowerCase());
    if(productTitle.textContent.includes("Sleep") || productTitle.textContent.includes("MAXX")){
      productTitle.classList.add("italic-text");
    }
    // desktop inject
